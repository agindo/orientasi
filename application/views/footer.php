...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url($url.'/ajax_list')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url($url.'/ajax_add')?>";
    } else {
        url = "<?php echo site_url($url.'/ajax_update')?>";
    }
...
function editData(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url($url.'/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function deleteData(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url($url.'/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
